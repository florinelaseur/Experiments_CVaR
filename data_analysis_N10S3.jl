...
var_flow_df = CSV.read(joinpath(@__DIR__, "outputs", "N10_seed3", "convex_conicalb_per_rp_24", "Gurobi", "var_flow.csv"), DataFrame)
var_flow_fixed_df = CSV.read(joinpath(@__DIR__, "outputs", "N10_seed3", "fixed", "convex_conicalb_per_rp_24CC", "Gurobi", "var_flow.csv"), DataFrame)
...
CSV.write(
    joinpath(@__DIR__, "outputs", "N10_seed3", "flow_difference_scenario_9_sorted.csv"),
...
CSV.write(
    joinpath(@__DIR__, "outputs", "N10_seed3", "aggregated_flow_differences_scenario7.csv"),
    flow_summary;
    writeheader=true,
)