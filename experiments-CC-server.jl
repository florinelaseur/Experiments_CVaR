...
Pkg.add(Pkg.PackageSpec(name="TulipaEnergyModel", version="0.22.2"))
...
function run_experiments()
    ...
    main_cc_path = joinpath(@__DIR__, "main-BNL-ScSeRP-hourly-outlier.jl")
    ...
    out = joinpath(@__DIR__, "experiment_log_ScSeRP.csv")
    mkpath(dirname(out))
    CSV.write(out, log)
