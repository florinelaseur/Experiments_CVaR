...
const MARKER_MAP = Dict("per_scenario" => :utriangle, "cross_scenario" => :circle, "kantorovich" => :diamond)

const LINE_MAP = Dict("per_scenario" => :solid, "cross_scenario" => :dot, "kantorovich" => :dash)

const COLOR_MAP_weight =
    Dict("dirac" => :red, "convex" => :black, "conical" => :green, "conical_bounded" => :yellow, "none" => :purple)
...
const FILLER_MAP =
    Dict("dirac" => :white, "convex" => :black, "conical" => :green, "conical_bounded" => :yellow, "none" => :purple)
