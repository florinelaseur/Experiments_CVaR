...
results_df = CSV.read(joinpath(output_path, "results_onlyclustering.csv"), DataFrame)
...
results_df |> CSV.write(joinpath(output_path, "stats_onlyclustering.csv"); writeheader=true)
